...
\section{Conceptual Extensions of Cosmochrony — Particles, Quantum Phenomena, and Classical Limits}
  ...
  Several sections of this appendix also serve as stability probes, designed to
  disentangle topological invariants from spectrally sensitive features of projected
  descriptions; in particular, Section~\ref{subsec:cp-asymmetry-and-chiral-selection}
  explicitly contrasts the robustness of chiral bias with the volatility of entanglement-related spectral peaks.
