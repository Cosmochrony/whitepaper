\subsection{CMB Polarization Signatures (Outlook)}
  ...
  As discussed in Section~\ref{subsec:cmb}, the fundamental
  spectral ratio $\lambda_2/\lambda_1 = 8/3$, which governs the electroweak mass hierarchy
  at the micro-scale (see Appendix~\ref{sec:spectral_ratio_derivation}), is expected to
  leave a structural signature on the Cosmic Microwave Background (CMB).
