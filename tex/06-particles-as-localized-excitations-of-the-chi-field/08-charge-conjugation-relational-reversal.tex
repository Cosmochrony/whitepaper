\subsection{Charge as a Topological and Relaxational Property of \texorpdfstring{$\chi$}{χ}}
  ...
  \subsubsection*{Charge as a Directed and Conjugate Relaxation Mode}
    ...
    The robustness of this chiral--torsional invariant is explicitly tested in
    Appendix~\ref{subsec:cp-asymmetry-and-chiral-selection}, where we show that the associated bias remains
    monotone and stable under spectral rearrangements that strongly affect entanglement amplitudes.
