\subsection{Spin and Statistics}
  ...
  Certain classes of admissible configurations possess a non-trivial internal covering structure of the admissible
  configuration space such that a $2\pi$ effective rotation does not return the configuration to an
  ...
  The connection between spin and statistics follows directly, at the descriptive level, from this topological
  distinction.
