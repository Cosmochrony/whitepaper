\subsection{Status of the Wavefunction}
  ...
  It arises at the level of effective descriptions as a statistical encoding of the set of admissible local
  reprojections compatible with a given non-factorizable projected configuration under global consistency constraints.

  \paragraph{Statistical and Relational Role of \texorpdfstring{$\psi$}{ψ}.}
    The wavefunction therefore does not represent an underlying structure or hidden dynamics.
    ...
    Its complex phase encodes relational constraints between alternative local descriptions within the effective
    formalism, while its modulus determines the statistical weight of accessible reprojections.
