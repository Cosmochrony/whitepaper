\section{Relational Formulation of \texorpdfstring{$\chi$}{χ} Dynamics}
  ...
  \paragraph{Purpose of the appendix.}
    ...
    \input{E-relational_formulation/04-relation-to-the-effective-geometric-description}
    \input{E-relational_formulation/05-relational_topological_stability}
    \input{E-relational_formulation/06-relational_spin_statistics}
    \input{E-relational_formulation/07-vacuum-energy-relaxation-capacity}
    \input{E-relational_formulation/08-conceptual-positioning}
