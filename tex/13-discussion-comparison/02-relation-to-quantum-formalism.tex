\subsection{Relation to Quantum Formalism}
  ...
  In contrast, Cosmochrony does not treat quantization or wave dynamics as
  fundamental.
  Instead, it describes a continuous pre-geometric substrate whose projected
  effective descriptions give rise to the formal apparatus of quantum theory.
  ...
  and the minimal temporal resolution required for a coherent effective
  description.
  The parameter $\nu$ does not represent a fundamental oscillation of $\chi$, but a
  frequency characterizing the projective structure of the emergent spacetime
  description.
  ...
  irreversible loss of relational accessibility due to interaction with the
  environment.
