\subsection{The Geometric Effective Action and Lagrangians of Cosmochrony $\left(\mathcal{L}_{\mathrm{CC}}\right)$}
  ...
  \subsubsection*{Explicit Form of the Connectivity Matrix $K_{ij}$}
    ...
    \begin{itemize}
      ...
      significantly weaken the effective connectivity. Its identification with specific microscopic or
      cosmological length scales depends on the physical regime considered and is discussed later.
