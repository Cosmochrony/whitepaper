\subsection{Microscopic Origin of the Coupling Tensor and the Poisson Equation}
  ...
  \paragraph{Status of effective equations.}
    ...
    are valid only within regimes where $\chi$ admits a smooth, weak-gradient geometric
    interpretation.
    They arise from coarse-graining the underlying $\chi$ relaxation dynamics
    ...
    equation governing $\chi$ at the pre-geometric level.
    Their domain of applicability is limited to configurations close to local equilibrium, where an effective spacetime
