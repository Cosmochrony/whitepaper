...
\subsection{Strong Gravity and Black Holes}
  ...
  \subsubsection{Black Holes, Deprojection, and Vacuum Reprojection}
    ...
    \paragraph{Information conservation and unitarity.}
      The deprojection process does not correspond to a destruction of information.
      Rather, it marks the loss of an effective spacetime encoding.
      Information that can no longer be represented in terms of localized geometric
      degrees of freedom is retained within the global configuration of the $\chi$ field
      as purely structural information.

      At the level of the $\chi$ substrate, the relaxation dynamics preserve the full
      configuration-space information.
      No fundamental violation of unitarity occurs at this level, even though the
      effective spacetime description may exhibit apparent non-unitary behavior.
      Such apparent information loss reflects the breakdown of spacetime observables
      in strongly constrained regimes, rather than a genuine loss of degrees of freedom.

      Unitarity in Cosmochrony is therefore preserved globally at the level of $\chi$,
      while effective non-unitarity may arise in projected spacetime descriptions,
      particularly in the presence of horizons or maximal confinement.
